...
public class FileUpload {
   ...
   */
  private static final String APPLICATION_NAME = "VRMLGenerator";

  private static final String UPLOAD_FILE_PATH = "generated.wrl";
  ...
  private static Credential authorize() throws Exception {
    ...
    GoogleClientSecrets clientSecrets = GoogleClientSecrets.load(JSON_FACTORY,
        new InputStreamReader(FileUpload.class.getResourceAsStream("/client_secret.json")));
  ...
  public static void uploadFile() {
    Preconditions.checkArgument(
        ...
        "Please enter the upload file path and download directory in %s", FileUpload.class);

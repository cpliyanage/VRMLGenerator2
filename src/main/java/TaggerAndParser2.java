...
public class TaggerAndParser2 {
	...
	static String[] objects = { "table", "chair", "box","cone","sphere", "cylinder", "sofa", "lamp", "bed","ball","bulb"};
	...
	public String tagContent(String input) throws IOException{
		...
		// creates a StanfordCoreNLP object, with POS tagging, lemmatization, NER, parsing, and coreference resolution
	     ...
	     //POS tagger start
	     System.out.println("POS Tagger Output");
	     ...
	     for(CoreMap sentence: sentences) {
		     ...
		     //Enhanced dependencies of the sentence    	 
			   ...
			   /*SemanticGraph enhancedPlusDependencies=sentence.get(SemanticGraphCoreAnnotations.EnhancedPlusPlusDependenciesAnnotation.class);
		       String enhancedPlusDependenciesList = enhancedPlusDependencies.toString(SemanticGraph.OutputFormat.LIST);
			   System.out.println(enhancedPlusDependenciesList);*/
